# Hass.io Add-on: Kocom Wallpad with RS485 DGL
...
1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/dgl0607/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
...
7. share/kocom2/ 폴더에 있는 kocom2.conf 파일을 본인의 환경에 맞게 수정합니다.
8. "START" 버튼으로 애드온을 실행합니다.

만일 kocom2.py 파일을 수정하시려면 한번 실행한 후 애드온을 Stop 하시고
